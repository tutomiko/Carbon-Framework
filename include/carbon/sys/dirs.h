...
FWIMPORT __success(return) bool_t directory_build_path(
	__in string_t const s_directory_path
);


FWIMPORT __success(return) bool_t directory_build_path_w(
	__in wstring_t const s_directory_path
);


FWIMPORT __success(return) bool_t directory_clear_contents(
	__in string_t const s_directory_path
);


FWIMPORT __success(return) bool_t directory_clear_contents_w(
	__in wstring_t const s_directory_path
);


FWIMPORT __success(return) bool_t directory_create(
	__in string_t const s_directory_path
);


FWIMPORT __success(return) bool_t directory_create_w(
	__in wstring_t const s_directory_path
);


FWIMPORT __success(return) bool_t directory_create_ex(
	__in string_t const s_directory_path,
	__in bool_t const   b_build_path
);


FWIMPORT __success(return) bool_t directory_create_ex_w(
	__in wstring_t const s_directory_path,
	__in bool_t const    b_build_path
);


FWIMPORT __success(return) bool_t directory_delete(
	__in string_t const s_directory_path
);


FWIMPORT __success(return) bool_t directory_delete_w(
	__in wstring_t const s_directory_path
);


FWIMPORT __success(return) bool_t directory_destroy(
	__in string_t const s_directory_path
);


FWIMPORT __success(return) bool_t directory_destroy_w(
	__in wstring_t const s_directory_path
);


FWIMPORT __success(return) bool_t directory_destroy_contents(
	__in string_t const s_directory_path
);


FWIMPORT __success(return) bool_t directory_destroy_contents_w(
	__in wstring_t const s_directory_path
);


FWIMPORT __success(return) bool_t directory_enum_contents(
	__in string_t const                s_directory_path,
	__in DIRECTORY_CONTENTS_ENUMERATOR f_enum_proc
);


FWIMPORT __success(return) bool_t directory_enum_contents_w(
	__in wstring_t const                 s_directory_path,
	__in DIRECTORY_CONTENTS_ENUMERATOR_W f_enum_proc
);


FWIMPORT __success(return) bool_t directory_enum_contents_ex(
	__in string_t const                   s_directory_path,
	__in DIRECTORY_CONTENTS_ENUMERATOR_EX f_enum_proc
);


FWIMPORT __success(return) bool_t directory_enum_contents_ex_w(
	__in wstring_t const                    s_directory_path,
