...
FWIMPORT __success(return) bool_t process_close(
	__in process_t const h_process
);


FWIMPORT __success(return) bool_t process_create(
...
FWIMPORT __success(return) bool_t process_create_w(
...
FWIMPORT __success(return) bool_t process_create_ex(
	__in      string_t const s_file_path,
	__in      uint_t const   n_parameter_count,
	__in_opt  string_t*      a_s_parameters,
...
FWIMPORT __success(return) bool_t process_create_ex_w(
	__in      wstring_t const s_file_path,
	__in      uint_t const    n_parameter_count,
	__in_opt  wstring_t*      a_s_parameters,
	__in_opt  ulong_t const   options,
...
FWIMPORT void process_current(
	__out process_t* _process
);


FWIMPORT void process_exit(
	__in unsigned int const exitcode
);


FWIMPORT __success(return) bool_t process_get_id(
...
/// </returns>
FWIMPORT __success(return) bool_t process_get_x64(
	__in_opt process_t const process,
	__out    bool_t*         _b_x64
);


FWIMPORT __success(return) bool_t process_getbinpath(
	__in_opt    process_t const process, 
...
FWIMPORT __success(return) bool_t process_getbinpath_w(
	__in_opt    process_t const process, 
...
FWIMPORT __success(return) bool_t process_getcdirpath(
	__inout     string_t s_path, 
	__inout_opt uint_t*  _n_path_length
);


FWIMPORT __success(return) bool_t process_getcdirpath_w(
	__inout     wstring_t s_path, 
	__inout_opt uint_t*   _n_path_length
);


FWIMPORT __success(return) bool_t process_getcwd(
	__inout     string_t s_path, 
	__inout_opt uint_t*  _n_path_length
);


FWIMPORT __success(return) bool_t process_getcwd_w(
	__inout     wstring_t s_path, 
	__inout_opt uint_t*   _n_path_length
);


FWIMPORT __success(return) bool_t process_kill(
	__in process_t const process
);


FWIMPORT __success(return) bool_t process_open(
...
FWIMPORT __success(return) bool_t process_resolvepath(
...
FWIMPORT __success(return) bool_t process_resolvepath_w(
