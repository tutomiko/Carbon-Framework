...
#
#
CBCIMPORT __success(return) bool_t nct_int_cto_string(
	__in  int_t const num,
	__out char_t*     s_num
);


CBCIMPORT __success(return) bool_t nct_int_cto_string_w(
	__in  int_t const num,
	__out wchar_t*    s_num
);


CBCIMPORT __success(return) bool_t nct_long_cto_string(
	__in  long_t const num,
	__out char_t*      s_num
);


CBCIMPORT __success(return) bool_t nct_long_cto_string_w(
	__in  long_t const num,
	__out wchar_t*     s_num
);


CBCIMPORT __success(return) bool_t nct_short_cto_string(
	__in  short_t const num,
	__out char_t*       s_num
);


CBCIMPORT __success(return) bool_t nct_short_cto_string_w(
	__in  short_t const num,
	__out wchar_t*      s_num
);


CBCIMPORT __success(return) bool_t nct_ulong_cto_string(
	__in  ulong_t const num,
	__out char_t*       s_num
);


CBCIMPORT __success(return) bool_t nct_ulong_cto_string_w(
	__in  ulong_t const num,
	__out wchar_t*      s_num
);


CBCIMPORT __success(return) bool_t nct_ushort_cto_string(
	__in  ushort_t const num,
	__out char_t*        s_num
);


CBCIMPORT __success(return) bool_t nct_ushort_cto_string_w(
	__in  ushort_t const num,
	__out wchar_t*       s_num
);


CBCIMPORT __success(return) bool_t nct_string_cto_int(
	__in  string_t const s_num,
	__out int_t*         _num
);


CBCIMPORT __success(return) bool_t nct_string_cto_int_w(
	__in  wstring_t const s_num,
	__out int_t*          _num
);


CBCIMPORT __success(return) bool_t nct_string_cto_long(
	__in  string_t const s_num,
	__out long_t*        _num
);


CBCIMPORT __success(return) bool_t nct_string_cto_long_w(
	__in  wstring_t const s_num,
	__out long_t*         _num
);


CBCIMPORT __success(return) bool_t nct_string_cto_longlong(
	__in  string_t const s_num,
	__out longlong_t*    _num
);


CBCIMPORT __success(return) bool_t nct_string_cto_longlong_w(
	__in  wstring_t const s_num,
	__out longlong_t*     _num
);


CBCIMPORT __success(return) bool_t nct_string_cto_short(
	__in  string_t const s_num,
	__out short_t*       _num
);


CBCIMPORT __success(return) bool_t nct_string_cto_short_w(
	__in  wstring_t const s_num,
	__out short_t*        _num
);


CBCIMPORT __success(return) bool_t nct_string_cto_ulong(
	__in  string_t const s_num,
	__out ulong_t*       _num
);


CBCIMPORT __success(return) bool_t nct_string_cto_ulong_w(
	__in  wstring_t const s_num,
	__out ulong_t*        _num
);


CBCIMPORT __success(return) bool_t nct_string_cto_ushort(
	__in  string_t const s_num,
	__out ushort_t*      _num
);


CBCIMPORT __success(return) bool_t nct_string_cto_ushort_w(
	__in  wstring_t const s_num,
	__out ushort_t*       _num
);
