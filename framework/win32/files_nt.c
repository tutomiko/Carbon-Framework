...
#
#
FWEXPORT __success(return) bool_t file_delete(__in string_t const file_path) {
...
FWEXPORT __success(return) bool_t file_exists(__in string_t const s_file_path, __out bool_t* _b_exists) {
#pragma region <locals>
	bool_t b_exists;
...
FWEXPORT __success(return) bool_t file_delete_w(__in wstring_t const file_path) {
#pragma region <locals>
...
FWEXPORT __success(return) bool_t file_exists_w(__in wstring_t const s_file_path, __out bool_t* _b_exists) {
#pragma region <locals>
	bool_t b_exists;
	HANDLE h_file = INVALID_HANDLE_VALUE;
#pragma endregion
...
FWEXPORT __success(return) bool_t file_rename(__in string_t const s_file_path, __in string_t const s_new_file_path) {
#pragma region <locals>
...
FWEXPORT __success(return) bool_t file_rename_w(__in wstring_t const s_file_path, __in wstring_t const s_new_file_path) {
#pragma region <locals>
...
FWEXPORT __success(return) bool_t file_zero(__in string_t const file_path) {
#pragma region <locals>
...
FWEXPORT __success(return) bool_t file_zero_w(__in wstring_t const file_path) {
#pragma region <locals>
	HANDLE        FileHandle = INVALID_HANDLE_VALUE;
	LARGE_INTEGER FileSize;
	ULONGLONG     TotalBytesToWrite, 
