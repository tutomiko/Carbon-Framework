...
#
#
CBCEXPORT __success(return) bool_t process_close(__in process_t const h_process) {
...
bool_t process_create(__in string_t const s_file_path, __in uint_t const n_parameter_count, __in_opt string_t* a_s_parameters, __out process_t* _h_process, __out_opt thread_t* _h_thread) {
#pragma region <locals>
...
CBCEXPORT __success(return) 
bool_t process_create_w(__in wstring_t const s_file_path, __in uint_t const n_parameter_count, __in_opt wstring_t* a_s_parameters, __out process_t* _h_process, __out_opt thread_t* _h_thread) {
#pragma region <locals>
	BOOL                b_created = FALSE;
	HANDLE              h_process = INVALID_HANDLE_VALUE;
	HANDLE              h_thread = INVALID_HANDLE_VALUE;
...
CBCEXPORT __success(return) 
bool_t process_create_ex(__in string_t const s_file_path, __in uint_t const n_parameter_count, __in_opt string_t* a_s_parameters, __in_opt ulong_t const options, __out process_t* _h_process, __out_opt thread_t* _h_thread) {
#pragma region <locals>
	BOOL                b_created = FALSE;
	DWORD               flags = 0;
	HANDLE              h_process = INVALID_HANDLE_VALUE;
...
CBCEXPORT __success(return) 
bool_t process_create_ex_w(__in wstring_t const s_file_path, __in uint_t const n_parameter_count, __in_opt wstring_t* a_s_parameters, __in_opt ulong_t const options, __out process_t* _h_process, __out_opt thread_t* _h_thread) {
#pragma region <locals>
	BOOL                b_created = FALSE;
	DWORD               flags = 0;
	HANDLE              h_process = INVALID_HANDLE_VALUE;
...
CBCEXPORT void process_current(__out process_t* _process) {
...
CBCEXPORT void process_exit(__in unsigned int const exitcode) {
	ExitProcess(exitcode);
}


CBCEXPORT __success(return) bool_t process_get_id(__in_opt process_t const process, __out ulong_t* _process_id) {
#pragma region <locals>
	ulong_t process_id;
#pragma endregion
...
CBCEXPORT __success(return) bool_t process_get_x64(__in_opt process_t const process, __out bool_t* _b_x64) {
#pragma region <locals>
	bool_t  b_x64;
	DWORD   e_binary_type;
...
CBCEXPORT __success(return) bool_t process_getbinpath(__in_opt process_t const h_process, __inout char_t* s_path, __inout_opt uint_t* _n_path_length) {
#pragma region <locals>
...
CBCEXPORT __success(return) bool_t process_getbinpath_w(__in_opt process_t const h_process, __inout wchar_t* s_path, __inout_opt uint_t* _n_path_length) {
#pragma region <locals>
...
CBCEXPORT __success(return) bool_t process_getcwd(__inout string_t s_path, __inout_opt uint_t* _n_path_length) {
#pragma region <locals>
	uint_t n_path_length;
#pragma endregion
...
CBCEXPORT __success(return) bool_t process_getcwd_w(__inout wstring_t s_path, __inout_opt uint_t* _n_path_length) {
#pragma region <locals>
	uint_t n_path_length;
#pragma endregion
...
CBCEXPORT __success(return) bool_t process_kill(__in process_t const process) {
#pragma region <locals>
...
CBCEXPORT __success(return) bool_t process_open(__in ulong_t const process_id, __in ulong_t const open_options, __out process_t* _process) {
#pragma region <locals>
