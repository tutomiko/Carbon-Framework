...
#include <fireworks/sys/console.h>
#pragma endregion
#
...
bool_t console_set_title(__in string_t const s_title) {
...
FWEXPORT __success(return) 
bool_t console_set_title_w(__in wstring_t const s_title) {
#pragma region <locals>
