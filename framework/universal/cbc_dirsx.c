...
CBCEXPORT __success(return) bool_t directory_build_path(__in string_t const s_directory_path) {
...
CBCEXPORT __success(return) bool_t directory_build_path_w(__in wstring_t const s_directory_path) {
#pragma region <locals>
	bool_t  b_create,
	        b_more,
		    b_iterate;
...
CBCEXPORT __success(return) bool_t directory_clear_contents(__in string_t const s_directory_path) {
	return directory_enum_contents_ex(s_directory_path, enum_clear_contents);
}


CBCEXPORT __success(return) bool_t directory_clear_contents_w(__in wstring_t const s_directory_path) {
	return directory_enum_contents_ex_w(s_directory_path, enum_clear_contents_w);
}


CBCEXPORT __success(return) bool_t directory_create_ex(__in string_t const s_directory_path, __in bool_t const b_build_path) {
	if (b_build_path)
...
CBCEXPORT __success(return) bool_t directory_create_ex_w(__in wstring_t const s_directory_path, __in bool_t const b_build_path) {
	if (b_build_path)
...
CBCEXPORT __success(return) bool_t directory_destroy(__in string_t const s_directory_path) {
	return directory_destroy_contents(s_directory_path) && directory_delete(s_directory_path);
}


CBCEXPORT __success(return) bool_t directory_destroy_w(__in wstring_t const s_directory_path) {
	return directory_destroy_contents_w(s_directory_path) && directory_delete_w(s_directory_path);
}


CBCEXPORT __success(return) bool_t directory_destroy_contents(__in string_t const s_directory_path) {
	return directory_enum_contents_ex(s_directory_path, enum_destroy_contents);
}


CBCEXPORT __success(return) bool_t directory_destroy_contents_w(__in wstring_t const s_directory_path) {
