...
#
#
CBCEXPORT __success(return) bool_t process_resolvepath(__in string_t const s_path, __in_opt uint_t const n_path_length, __inout string_t s_abs_path, __out_opt uint_t* _n_abs_path_length) {
...
CBCEXPORT __success(return) bool_t process_resolvepath_w(__in wstring_t const s_path, __in_opt uint_t const n_path_length, __inout wstring_t s_abs_path, __out_opt uint_t* _n_abs_path_length) {
#pragma region <locals>
	uint_t  n_abs_path_length;
	uint_t  n_cwd_path_length;
	wpath_t s_cwd_path;
