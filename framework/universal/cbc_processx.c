...
#
#
CBCEXPORT __success(return) bool_t process_getcdirpath(__inout string_t s_path, __inout_opt uint_t* _n_path_length) {
...
CBCEXPORT __success(return) bool_t process_getcdirpath_w(__inout wstring_t s_path, __inout_opt uint_t* _n_path_length) {
#pragma region <locals>
	uint_t n_path_length;
#pragma endregion
